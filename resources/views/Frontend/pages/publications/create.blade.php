        ...
        <div class="row">
            ...
            <div class="col-sm-10 col-md-10 col-lg-6 pb-4">
                <div class="card py-2 bg-primary">
                    <h5 class="text-white text-center">Publish New Paper/Project</h5>
                </div>
                <div class="card bg-light">
                    <form class="text-start p-4" action="{{ route('user.PublicationStore') }}" method="POST"
                        ...
                        <div class="container">
                            ...
                            <div class=" mb-4">
                                <label class="form-label text-start fw-bold" for="paper_title">Paper/Project Title
                                    <span class="text-danger fw-normal">*</span></label>
                                <input
                                    class="form-control @error('paper_title')
                        is-invalid
                    @enderror"
                                    value="{{ old('paper_title') }}" type="text" name="paper_title" id="paper_title"
                                    placeholder="Enter paper title" style="height: 50px !important;">
                                @error('paper_title')
                        ...
                        is-invalid
                    @enderror"
                                    type="text" value="{{ old('author') }}" name="author" id="author"
                                    placeholder="Enter authors name" style="height: 50px !important;">
                                @error('author')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                    ...
                    @enderror"
                        ...
                        @enderror">{{ old('abstract') }}
                            ...
                            <div class=" mb-4">
                                <label class="form-label text-start fw-bold" for="paper_area">Select Paper/Project Area
                                    <span class="text-danger fw-normal">*</span></label>
                                <select
                    ...
                    @enderror"
                            ...
                            <div class=" mb-4">
                                <label class="form-label text-start fw-bold" for="">Publication Type <span
                                        class="text-danger fw-normal">*</span></label>
                                <select
                                    class="form-select  form-control @error('publication_type')
                      is-invalid
                  @enderror"
                                    aria-label="Default select example" name="publication_type">
                                    <option value="Papar">Research Papar</option>
                            ...
                            <div class=" mb-4">
                                <label class="form-label text-start fw-bold" for="file_upload">Attach File
                                    <span class="text-danger fw-normal">*</span>
                                </label>
                                <input type="file" class="form-control @error('file_upload') is-invalid @enderror"
                                    id="file_upload" name="file_upload" value="{{ old('file_upload') }}"
