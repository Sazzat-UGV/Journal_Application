        ...
        <tr>
            <td>
                <table align="center" width="600" cellpadding="0" cellspacing="0" style="border-collapse: collapse; background-color: #ffffff;">
                    <!-- Header -->
                    <tr>
                        <td style="padding: 20px 20px 10px; text-align: center; background-color: #007BFF; color: #fff;">
                    ...
                    <tr>
                        <td style="padding: 20px;">
                            ...
                            <p style="text-align: center; padding-top: 10px; padding-bottom: 10px;">
                                <a href="{{ route('home.resetPasswordPage',$token) }}">Reset Password</a>
                            </p>
                    ...
                    <tr>
                        <td style="padding: 20px; text-align: center; background-color: #f4f4f4;">
                            &copy; 2023 UGV Journals. All rights reserved.
                        </td>
                    </tr>
                </table>
            </td>
