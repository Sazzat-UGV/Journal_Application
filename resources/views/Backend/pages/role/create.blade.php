        ...
        <div class="row">
            ...
            <div class="col-12">
                <form action="{{ route('role.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="role_name" value="{{ old('role_name') }}" placeholder="Enter role name"
            ...
            @enderror">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="role_note" value="{{ old('role_note') }}" placeholder="Enter role note"
